...
<body>
    ...
    <?php
    //Mise en place d'une condition pour ne plus afficher le formulaire quand le patient a bien été enregistré
    if (!$addPatientInBase) { ?>
        <p class="h3 text-danger"><?= $messages['addPatient'] ?? '' ?></p>
        ...
        <form class="container col-4 shadow-lg rounded" action="ajout-patients.php" method="POST">
            ...
            <button type="submit" class="btn btn-primary" name="addPatientBtn">Envoyer</button>
        </form>
